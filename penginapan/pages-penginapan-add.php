<?php
include "proses-penginapan-add.php";
?>
<!DOCTYPE html>
<html lang="en">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="mb-3 <?php echo (!empty($description_err)) ? 'has-error' : ''; ?>">
										...
										<textarea class="form-control span12" rows="1" name="description" type="text"
							...
							<div class="col-lg-6">
								<div class=" form-group">
                                        <div class="mb-3 <?php echo (!empty($hotel_facility_err)) ? 'has-error' : ''; ?>">
                                            <label class="form-label"style="color: black;"><strong>Hotel Facility</strong></label>
                                            <select name="hotel_facility" class="form-select mb-3" value="<?php echo $hotel_facility; ?>">
												<option <?php echo ($hotel_facility == 'Chinnes Food') ? "selected": "" ?>>Chinnes Food</option>
												<option <?php echo ($hotel_facility == 'Western Food') ? "selected": "" ?>>Western Food</option>
												<option <?php echo ($hotel_facility == 'Java Food') ? "selected": "" ?>>Java Food</option>
												<option <?php echo ($hotel_facility == 'Maduran Food') ? "selected": "" ?>>Maduran Food</option>
											</select>
										...
										<div class="form-group">
											<div class="mb-3 <?php echo (!empty($website_err)) ? 'has-error' : ''; ?>">
												...
												<input class="form-control form-control-lg" type="text" name="website" placeholder="Enter your Hotel website" value="<?php echo $website; ?>">
							...
							<div class="col-12">
								...
								<div class="row">
									...
									<div class="mb-3 <?php echo (!empty($address_err)) ? 'has-error' : ''; ?>">
										...
										placeholder="Enter your Hotel address" value="<?php echo $address; ?>" ></textarea>

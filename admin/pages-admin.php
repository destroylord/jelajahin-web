											...
											echo"<tbody>";
												...
												echo "<tr>";
													...
													echo "<td >";
														...
														echo "<a href='delete-admin.php?uuid_admin=". $row['uuid_admin'] ."' title='Delete Record' data-toggle='modal tooltip'><span class='align-middle mx-2' data-feather='trash' style='color: black;'></span></a>";
													echo "</td>";
												echo "</tr>";
												}
											echo"</tbody>";

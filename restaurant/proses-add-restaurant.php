...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    move_uploaded_file($_FILES['image']['tmp_name'], "../img/photos/".$image);
	...
	&& empty($kabupaten_err) && empty($kecamatan_err) && empty($kelurahan_err) && empty($address_err) && empty($latitude_err) && empty($longitude_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "ssssssssssssssssss", $param_uuid_restaurant, $param_name, $param_description, $param_price_min, $param_price_max, $param_food_type, 
			$param_restaurant_type, $param_phone, $param_website, $param_business_time_open, $param_business_time_closes, $param_provinsi, 

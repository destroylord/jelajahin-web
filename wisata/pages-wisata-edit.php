...
session_start();
    ...
    $uuid = $_GET['uuid_wisata'];
                  
    $sql    = mysqli_query($link, "SELECT * FROM wisata WHERE uuid_wisata = '$uuid' ");
		...
		<div class="main mx-auto" style="background-color: #E5E5E5;">
			...
			<main class="content">
				<div class="container-fluid p-0" >
					...
					<form class="container scrollspy-example" action="edit.php" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-12">
						...
						<div class="row">	
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<input type="number" name="ticket_price" id="" value="<?=$data['ticket_price']?>"  class="form-control">
								</div>
							</div>
						</div>
					<div class="row mt-4">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="province" id="" value="<?=$data['province_name']?>" class="form-control">
							...
							<div class="form-group">
								...
								<select name="city" id="" value="<?=$data['city_name']?>" class="form-control">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" name="latitude" id="" value="<?=$data['latitude']?>" class="form-control">
							</div>
							<div class="form-group">
								<label for="">longtitude</label>
								<input type="number" name="longtitude" id="" value="<?=$data['longtitude']?>" class="form-control">
							</div>
						</div>
					</div>
